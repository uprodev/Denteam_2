...
if($args):
	...
	<section class="cards-list cards-list-01"<?php if($background) echo ' style="background-color: ' . $background . ';"' ?><?php if($id) echo ' id="' . $id . '"' ?>>
						...
						if($treatments): ?>
							...
							foreach($treatments as $post): 
								...
								<div class="swiper-slide">
									<?php get_template_part('parts/content', 'treatment'); ?>
								</div>
								<?php 
							endforeach; 
							wp_reset_postdata(); 
