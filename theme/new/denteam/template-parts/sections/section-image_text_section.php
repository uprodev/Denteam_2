...
if($args):
	...
	<?php if ($rows): ?>
		<section class="text-with-image-wrapper"<?php if($id) echo ' id="' . $id . '"' ?>>

			<?php foreach ($rows as $item): ?>
				<div class="text-with-image <?= $item['media_position'] == 'Right' ? 'text-with-image--img-right' : 'text-with-image--img-left' ?><?php if($item['background_color'] == 'Grey') echo ' text-with-image--bg' ?>">
