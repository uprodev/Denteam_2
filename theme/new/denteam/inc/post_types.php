...
function create_taxonomy(){
	...
	register_taxonomy( 'behandelaar_cat', [ 'behandelaar' ], [
		'label'                 => '', 
		'labels'                => [
			'name'              => __('Behandelaren Categories', 'Denteam'),
			'singular_name'     => __('Behandelaren Category', 'Denteam'),
			'search_items'      => __('Search Behandelaren Categories', 'Denteam'),
			'all_items'         => __('All Behandelaren Categories', 'Denteam'),
			'view_item '        => __('View Behandelaren Category', 'Denteam'),
			'parent_item'       => __('Parent Behandelaren Category', 'Denteam'),
			'parent_item_colon' => __('Parent Behandelaren Category:', 'Denteam'),
			'edit_item'         => __('Edit Behandelaren Category', 'Denteam'),
			'update_item'       => __('Update Behandelaren Category', 'Denteam'),
			'add_new_item'      => __('Add New Behandelaren Category', 'Denteam'),
			'new_item_name'     => __('New Behandelaren Category Name', 'Denteam'),
			'menu_name'         => __('Behandelaren Category', 'Denteam'),
			'back_to_items'     => __('← Back to Behandelaren Category', 'Denteam'),
		],
		'description'           => '',
		'public'                => true,
		// 'publicly_queryable'    => null,
...
function register_post_types(){
	...
	register_post_type( 'behandelaar', [
		'label'  => null,
		'labels' => [
			'name'               => __('Behandelaren', 'Denteam'), 
			'singular_name'      => __('Behandelaren', 'Denteam'), 
			'add_new'            => __('Add', 'Denteam'),
			'add_new_item'       => __('Add', 'Denteam'), 
			'edit_item'          => __('Edit', 'Denteam'),
			'new_item'           => __('New', 'Denteam'), 
