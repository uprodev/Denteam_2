	...
	<section class="video-block">
		<div class="container-fluid">
			...
			<div class="video-wrapper" style="background-image:url('<?= $cover_image['url'] ?>'); background-size:cover; background-position: center; background-repeat:no-repeat;">
				<button type="button" class="video-play-modal" data-bs-toggle="modal" data-bs-target="#<?= $id; ?>"></button>
			</div>

		</div>
		<div class="modal modal-video fade" id="<?= $id; ?>" tabindex="-1" aria-hidden="true">
